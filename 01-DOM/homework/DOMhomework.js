...
// [NOTA: Algunas cuestiones a tener en cuenta sobre el elemento 'input' de HTML (Ya que 'toDoInput' es 
// un input)
// Todos los elementos input tienen una propiedad llamada 'value' que nos permite acceder al texto que 
// se encuentre actualmente escrito dentro del input]
...
// Todo Event Listener recibe como parámetro el objeto 'event' conteniendo un montón de información que 
// incluye el tipo del evento, que elemento fue el que lo llamó, los valores de dicho elemento, etc.
// En este paso vamos a utilizarlo para encontrar el index del item que disparó el evento (Esta parte 
// ya se encuentra desarrollada pero está comentada dentro de la función por lo que va a ser necesario 
// que la descomenten)]
//   1) Utilizando el index suministrdo, llamar a 'completeToDo' (Recuerden que habíamos creado dcho 
//      método en el prototipo de la clase ToDo) sobre el elemento correspondiente del array toDoItems
